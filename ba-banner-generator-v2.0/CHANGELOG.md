...
### New
- **Auto Layout support** — complete rewrite of the rendering engine to generate CSS flexbox-based HTML output from Figma Auto Layout frames instead of absolute-positioned PNGs.

> **Version branching note:** v1.x continues to be maintained for Figma files using absolute positioning. v2.x is exclusively for Auto Layout-based files.
